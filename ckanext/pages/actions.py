...
schema = {
    'id': [p.toolkit.get_validator('ignore_empty')],
    ...
    'content': [p.toolkit.get_validator('ignore_missing')],
    'page_type': [p.toolkit.get_validator('ignore_missing')],
  #  'lang': [p.toolkit.get_validator('not_empty')],
    ...
    'group_id': [p.toolkit.get_validator('ignore_missing')],
    'user_id': [p.toolkit.get_validator('ignore_missing')],
